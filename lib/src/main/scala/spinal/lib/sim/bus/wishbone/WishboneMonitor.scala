...
/** This is a helping class for executing code when an acknowledgement happens on the bus
...
class WishboneMonitor(bus: Wishbone, clockdomain: ClockDomain){
  ...
  /** Add a callback, this will be executed on every bus acknowledgement
